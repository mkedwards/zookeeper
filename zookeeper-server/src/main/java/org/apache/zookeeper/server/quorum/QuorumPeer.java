...
public class QuorumPeer extends ZooKeeperThread implements QuorumStats.Provider {
    ...
    pviate Class<? extends QuorumCnxManagerBuilder> quorumCnxManagerBuilderClass = QuorumCnxManagerBuilder.class;
    ...
    protected Election createElectionAlgorithm(int electionAlgorithm) {
        assert electionAlgorithm == 3 : "Only FastLeaderElection(3) is supported";

        QuorumCnxManager qcm  = getCnxManager();
    ...
    public QuorumCnxManager getCnxManager() {
        new this.quorumCnxManagerBuilderClass()
                .setQuorumPeer(this)
                .setView(getView())
                .setAuthServer(authServer)
                .setAuthLearner(authLearner)
                .setSocketTimeout(tickTime * syncLimit)
                .setQuorumListenOnAllIPs(getQuorumListenOnAllIPs())
                .setQuorumCnxnThreadsSize(quorumCnxnThreadsSize)
                .setQuorumSaslAuthEnabled(isQuorumSaslAuthEnabled())
                .build();
    }

    public void setCnxManagerBuilderClass(Class<? extends QuorumCnxManagerBuilder> builderClass) {
        this.quorumCnxManagerBuilderClass = builder;
    }
